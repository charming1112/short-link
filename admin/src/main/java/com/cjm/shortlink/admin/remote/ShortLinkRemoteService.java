package com.cjm.shortlink.admin.remote;
...
public interface ShortLinkRemoteService {
    ...
    default void saveRecycleBin(RecycleBinSaveReqDTO requestParam) {
        String resultBodyStr = HttpUtil.post("http://127.0.0.1:8001/api/short-link/admin/v1/recycle-bin/save", JSON.toJSONString(requestParam));
    }
}
